...
<html lang="en">
<head>
  <title>Allot KeepItTidy - Housekeeper Admin Dashboard</title>
      ...
      <div class="container-fluid">
        ...
        <?php if (isset($_SESSION['admin_logged'])) : ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
            ...
            <span class="alert-inner--text"><strong>Welcome to KeepItTidy-online Housekeeping admin portal.</strong>

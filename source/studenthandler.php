<?php
  ...
  if (isset($_POST['reqSubmit']) && isset($_SESSION['rollnumber'])) {
      ...
      $stmt = $db->prepare("INSERT INTO cleanrequest (rollnumber, date, cleaningtime) VALUES (?, ?, ?)");
      $stmt->bind_param("sss", $rollnumber, $reqdate, $reqTime);
      ...
      try {
          ...
          $_SESSION['req_failed'] = "Error: " . $e->getMessage();
      }

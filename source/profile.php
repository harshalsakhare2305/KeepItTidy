...
<html lang="en">
<head>
  <title>Student Profile - KeepItTidy Student Dashboard</title>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <!-- <div class="col text-right">
                  <a href="harshalsakhare2305@gmail.com" target="_blank" class="btn btn-sm btn-primary">Request Change</a>
                </div> -->
              </div>
            </div>
